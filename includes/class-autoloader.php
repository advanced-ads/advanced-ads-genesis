		...
		<div class="notice notice-error">
			<p>
				...
				printf(
					...
					esc_html__( 'Your installation of Advanced Ads is incomplete. If you installed Advanced Ads from GitHub, %1$s please refer to this document%2$s to set up your development environment.', 'advanced-ads-genesis' ),
	...
	private function get_environment_type_fallback(): string {
		...
		if ( defined( 'WP_ENVIRONMENT_TYPES' ) && function_exists( '_deprecated_argument' ) ) {
			if ( function_exists( '__' ) ) {
				...
				$message = sprintf( __( 'The %s constant is no longer supported.', 'advanced-ads-genesis' ), 'WP_ENVIRONMENT_TYPES' );
			} else {
